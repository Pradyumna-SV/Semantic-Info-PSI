...
from Purification.models.cm import ClusterMemory_teacher
from Purification.trainers import Trainer_teacher
...
def main_worker(args):
    ...
    trainer = Trainer_teacher(model,args)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Learning to Purification for unsupervised re-ID")
    # data
    ...
    parser.add_argument('--k2', type=int, default=6,
                        help="hyperparameter for jaccard distance")
    #new
    parser.add_argument('--Lambda1', type=float, default=1.0, help="Regularization parameters for total loss")
    parser.add_argument('--Lambda2', type=float, default=5.0, help="Regularization parameters for total loss")
    parser.add_argument('--knn', type=int, default=5, help="k for nearest-neighbor contrastive loss")
    parser.add_argument('--gcnk1', type=int, default=5, help="K for global feat of Graph Convolution Network")
    parser.add_argument('--gcnk2', type=int, default=3, help="K for cross_cam feat of Graph Convolution Network")
    parser.add_argument('--nncl', action="store_true")
